...
This file carries only what is Claude Code-specific: maintenance semantics for
`claude-code/settings.json` and command frontmatter. No extra response calibration
is needed here -- the deployed `~/.claude/CLAUDE.md` already carries it globally.
