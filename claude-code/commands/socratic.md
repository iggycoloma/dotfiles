---
description: Learn a topic via the Socratic method with Claude acting as a subject-matter expert (leads with questions, withholds answers to make you reason)
argument-hint: [topic]
...
The topic to teach is: **$ARGUMENTS**. If no topic was given, ask the user what they want
