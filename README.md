...
| Agents (Claude Code)            | 1     | code-reviewer: fresh-context, read-only review of the working diff via the review-pr rubric           |
| Shared Agent Skills             | 22    | Portable Claude/Codex workflows including `/commit`, `/review-pr`, `/plan-migration`, and `/draft-adr` |
