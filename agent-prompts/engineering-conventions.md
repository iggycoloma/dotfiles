...
4. **Text destined for the forge web UI (PR, MR, issue, and comment bodies) follows `forge.md`**, deployed alongside this file, which inverts this default: forge bodies do NOT hard-wrap.
